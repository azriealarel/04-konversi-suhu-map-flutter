...
import 'package:jobsheet4/widget/dropdown_conversion.dart';
import 'package:jobsheet4/widget/result.dart';
import 'package:jobsheet4/widget/conversion_history.dart';
import 'package:jobsheet4/widget/user_input.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Muhammad Azrieal Rhamdan',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const Text('2031710169',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(
            height: 10,
          ),
